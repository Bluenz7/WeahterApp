...
extension FirstCollectionViewCell {
    func configuredCell(by model: Any) {
        ...
        iconURL.kf.setImage(with: model.iconURL)
...
extension FirstCollectionViewCell {
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            iconURL.topAnchor.constraint(equalTo: hourLabel.bottomAnchor, constant: 5),
            iconURL.centerXAnchor.constraint(equalTo: centerXAnchor),
            iconURL.widthAnchor.constraint(equalToConstant: 35),
            iconURL.heightAnchor.constraint(equalToConstant: 35),
            
            tempLabel.topAnchor.constraint(equalTo: iconURL.bottomAnchor, constant: 5),
